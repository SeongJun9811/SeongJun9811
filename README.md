...
- `2024.08 - 2024.10`　 산업 종사자별 환경 인식 전환에 대한 베이지안 잠재계층모형 분석 = Analysis of Environmental Awareness by Industry Group Using Bayesian Latent Class Model(2024 환경 데이터 분석(활용) 아이디어 공모전, [**입선**]).
